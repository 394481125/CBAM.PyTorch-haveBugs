...
def main(args):
    ...
    train_dataloaders = torch.utils.data.DataLoader(train_datasets, batch_size=args.batch_size, shuffle=True, num_workers=8)
    ...
    # 设置基础网络
    my_model = resnet_cbam.resnet101_cbam()
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--model', default='resnet101_cbam',
